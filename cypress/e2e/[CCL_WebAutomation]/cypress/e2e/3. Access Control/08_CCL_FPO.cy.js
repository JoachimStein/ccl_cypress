    ...
    foreign_pr_user_ids.forEach((user, index) => {
        it(`User for Foreign Purchase : ${user.role}`, () => {
            ...
            if (userIndex === 0) {
                ...
                cy.wait(1000)
                cy.get("#purchase_base_0").select('Comparative Statement')    //select base
                cy.wait(1000)
                ...
                cy.wait(1000)
                cy.get("table[class='o_list_table table table-sm table-hover position-relative mb-0 o_list_table_ungrouped table-striped']>tbody>tr:first-child>td:nth-child(7)").type("1")
                cy.wait(1000)
