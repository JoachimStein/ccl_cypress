describe("mrr(qc)_testsuite", function(){
    it("process_flow_dp", function(){
        ...
        cy.wait(1000)
        cy.get("table[class='o_list_table table table-sm table-hover position-relative mb-0 o_list_table_ungrouped table-striped']>tbody>tr:first-child>td:nth-child(5)").type("15")
        cy.wait(1000)
        ...
        cy.wait(1000)
        cy.get("table[class='o_list_table table table-sm table-hover position-relative mb-0 o_list_table_ungrouped table-striped']>tbody>tr:first-child>td:nth-child(7)").type('50').type('{Enter}')
        cy.wait(1000)
        ...
        cy.wait(1000)
        cy.get("#subject_0").type("Automated Testing: PR>RFQ>Q>NS(RFQ)>DPO>MRR(QC)")
        cy.wait(1000)
