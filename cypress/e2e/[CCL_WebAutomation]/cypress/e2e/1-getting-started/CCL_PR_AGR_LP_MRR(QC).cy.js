describe("mrr(qc)_testsuite", function(){
    it("process_flow_LP", function(){
        ...
        cy.wait(1000)
        cy.xpath("//span[contains(.,'10')]").click()
        cy.wait(1000)
        cy.get("#end_date_0").click()
        cy.wait(1000)
        cy.xpath("//span[contains(.,'11')]").click()
        cy.wait(1000)
        cy.get("#active_0").type('{Enter}')
        cy.wait(1000)
        ...
        cy.wait(1000)
        cy.get("table[class='o_section_and_note_list_view o_list_table table table-sm table-hover position-relative mb-0 o_list_table_ungrouped table-striped']>tbody>tr:first-child>td:nth-child(7)").type('2')
        cy.wait(1000)
        cy.xpath("//span[contains(.,'Submit')]").click()
        cy.wait(1000)
