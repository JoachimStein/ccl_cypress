describe("mrr(qc)_testsuite", function(){
    it("process_flow_dp", function(){
        ...
        cy.wait(1000)
        cy.get("table[class='o_section_and_note_list_view o_list_table table table-sm table-hover position-relative mb-0 o_list_table_ungrouped table-striped']>tbody>tr:first-child>td:nth-child(11)").type("1200")
        cy.xpath("//span[contains(.,'Submit')]").click()
        cy.wait(1000)
