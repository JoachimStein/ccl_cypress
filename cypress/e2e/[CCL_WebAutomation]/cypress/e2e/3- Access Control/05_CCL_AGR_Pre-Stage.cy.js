describe("Agreement_access_right", function () {
    const user_ids = [
        // {
        //     userName: "scm.user",
        //     role: "SCM Initiator"
    ...
    user_ids.forEach((user, index) => {
        it(`User for Agreement : ${user.role}`, () => {
            ...
            if (userIndex === 0) {
                ...
                cy.wait(1000)
                cy.get("#vendor_id_0").type("Madina Store").type('{Enter}') // Vendor Name
                cy.wait(1000)
                ...
                cy.wait(1000)
                cy.xpath("//span[contains(.,'31')]").click() // Give End Date
                cy.wait(1000)
